...
A10_MGMT_IP=os.environ["A10_MGMT_IP"]
A10_MGMT_PORT=os.environ["A10_MGMT_PORT"]
A10_MGMT_USER=os.environ["A10_MGMT_USER"]
A10_MGMT_PASSWD=os.environ["A10_MGMT_PASSWD"]
...
A10_VIP_IP = os.environ["virtual_server_ip"]
A10_SERVICE_PROTOCOL = os.environ["virtual_service_protocol"]
A10_SERVICE_PORT = os.environ["virtual_service_port"]
A10_REAL_SERVER_PORT = os.environ["virtual_service_port"]
...
if cmd == "start":
    ...
    for i in range(1,6):
        for j in range (0,1):
            new=[]
            new.append(SERVER_NAME+str(i))
            NEW_REAL_SERVER_NAMES.append(SERVER_NAME+str(i))
    ...
    for item in sg_ml:
        ...
        for i in range(0, 1):
            ...
            i -= 1
        VIP_SG_SLB_SERVER_IP_W_IPS.append(temp)
    ...
    print "Servers_To_Remove", Servers_To_Remove
