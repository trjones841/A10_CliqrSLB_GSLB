...
IP_SOURCE_NAT = "10_1_31_SNAT"
SVR_NAME = "s_NEW_PYTHON_SRVR0"
...
if cmd == "start":
    ...
    for i in range(1, 6):
        for j in range(0, 1):
            temp=[]
            temp.append(SVR_NAME+str(i))
            NEW_REAL_SERVER_NAMES.append(SVR_NAME+str(i))
            temp.append("10.1.31.3"+str(i))
    ...
    vs_port = Port(protocol=A10_SERVICE_PROTOCOL, port_number=A10_SERVICE_PORT, service_group=SERVICE_GROUP_NAME,
                   pool=IP_SOURCE_NAT, DeviceProxy=dp)
